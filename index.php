...
<body>
    <div id="main">
        <div id="header">
            <a href="#" class="logo"><img src="img/logo.jpg" width="130" height="100" alt="" /></a>
        </div>  
       <div id="middle">
            <div id="left-column">
                <!-- <h3>Walak Nane</h3>
       ...
       <!---     
        ...
        <div id="footer"><p>Developed by <a href="https://heppyria.netlify.app/">PSIK 22 B</a> 2024.</p></div>
